...
| 7 | 2026-06-18 | 20260618T145323Z | gskhw4w4lm, v08dlrgr7v | Bounded daily pull; both media IDs included | 2 | 107,113 | 586,948 | Yes | Yes | 786 | Media metadata/stats captured for both IDs. Visitors/events capped at 100 pages for both media IDs. Ingestion command timed out locally after writing the full expected raw file set; file counts confirmed before transformation. S3 sync used reduced AWS CLI concurrency/adaptive retries. Athena row-count validation succeeded after MSCK repair. |
